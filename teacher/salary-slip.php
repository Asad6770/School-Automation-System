                        ...
                        <div class="col-md-12">
                            ...
                            <div class="row">
                                ...
                                <table class="mt-4 table text-center table-bordered">
                                    ...
                                    <tbody>
                                        <tr>
                                            <th scope="row"><?= $data[0]['basic_salary'] ?></th>
                                            <td><?= $data[0]['allowances'] ?></td>
                                            <td>-</td>
                                        </tr>
                                    </tbody>
                                </table>
                            ...
                            <div class="row">
                                <div class="col-4"> <br> <span class="font-weight-bold">Net Pay</span> : <?= $data[0]['basic_salary'] + $data[0]['allowances'] ?> </div>
